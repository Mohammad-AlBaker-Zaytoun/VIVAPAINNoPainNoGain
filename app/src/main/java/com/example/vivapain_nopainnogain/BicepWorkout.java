...
public class BicepWorkout extends AppCompatActivity {
    ...
    private void initBackBtn() {
        backBtn.setOnClickListener(v -> {
            Intent intent = new Intent(BicepWorkout.this, Activities.class);
    ...
    private void initCheckWifi() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            if (!WifiConnected && MobileDataConnected) {
                Toast.makeText(BicepWorkout.this, "You are using mobile data connection", Toast.LENGTH_LONG).show();
            }
        } else {
            Toast.makeText(BicepWorkout.this, "NO CONNECTION!", Toast.LENGTH_SHORT).show();
            noConnectionDialog();
        }
    }
