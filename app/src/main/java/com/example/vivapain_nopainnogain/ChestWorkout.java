...
public class ChestWorkout extends AppCompatActivity {
    ...
    private void initBackBtn() {
        backBtn.setOnClickListener(v -> {
            Intent intent = new Intent(ChestWorkout.this, Activities.class);
    ...
    private void initCheckWifi() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            if (!WifiConnected && MobileDataConnected) {
                Toast.makeText(ChestWorkout.this, "You are using mobile data connection", Toast.LENGTH_LONG).show();
            }
        } else {
            Toast.makeText(ChestWorkout.this, "NO CONNECTION!", Toast.LENGTH_SHORT).show();
            noConnectionDialog();
        }
    }
