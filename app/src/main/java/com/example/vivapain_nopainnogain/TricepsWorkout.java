...
public class TricepsWorkout extends AppCompatActivity {
    ...
    private void initBackBtn() {
        backBtn.setOnClickListener(v -> {
            Intent intent = new Intent(TricepsWorkout.this, Activities.class);
    ...
    private void initCheckWifi() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            if (!WifiConnected && MobileDataConnected) {
                Toast.makeText(TricepsWorkout.this, "You are using mobile data connection", Toast.LENGTH_LONG).show();
            }
        } else {
            Toast.makeText(TricepsWorkout.this, "NO CONNECTION!", Toast.LENGTH_SHORT).show();
            noConnectionDialog();
        }
    }
