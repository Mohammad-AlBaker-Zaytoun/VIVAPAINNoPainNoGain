...
public class Snacks1 extends AppCompatActivity {
    ...
    private void initExitBtn() {
        exitBtn.setOnClickListener(v -> {
            Intent intent = new Intent(Snacks1.this, Food_Diet.class);
    ...
    private void initNextBtn() {
        nextBtn.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Snacks1.this, Snacks1.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        });
    }
    ...
    private void initCheckWifi() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            if (!WifiConnected && MobileDataConnected) {
                Toast.makeText(Snacks1.this, "You are using mobile data connection", Toast.LENGTH_LONG).show();
            }
        } else {
            Toast.makeText(Snacks1.this, "NO CONNECTION!", Toast.LENGTH_SHORT).show();
            noConnectionDialog();
        }
    }
        ...
        call.enqueue(new Callback<snacksResult>() {
            ...
            public void onResponse(@NonNull Call<snacksResult> call, @NonNull Response<snacksResult> response) {
                if (response.code() == 200) {
                    ...
                    Toast.makeText(Snacks1.this, "server error", Toast.LENGTH_LONG).show();
                }
            ...
            public void onFailure(@NonNull Call<snacksResult> call, @NonNull Throwable t) {
                Toast.makeText(Snacks1.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
