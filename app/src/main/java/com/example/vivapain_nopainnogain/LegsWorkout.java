...
public class LegsWorkout extends AppCompatActivity {
    ...
    private void initBackBtn() {
        backBtn.setOnClickListener(v -> {
            Intent intent = new Intent(LegsWorkout.this, Activities.class);
    ...
    private void initCheckWifi() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            if (!WifiConnected && MobileDataConnected) {
                Toast.makeText(LegsWorkout.this, "You are using mobile data connection", Toast.LENGTH_LONG).show();
            }
        } else {
            Toast.makeText(LegsWorkout.this, "NO CONNECTION!", Toast.LENGTH_SHORT).show();
            noConnectionDialog();
        }
    }
