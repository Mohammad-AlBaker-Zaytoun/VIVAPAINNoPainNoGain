...
public class Snacks2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snacks2);
    ...
    private void initExitBtn() {
        exitBtn.setOnClickListener(v -> {
            Intent intent = new Intent(Snacks2.this, Food_Diet.class);
    ...
    private void initNextBtn() {
        nextBtn.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(Snacks2.this, Snacks2.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        });
    }
    ...
    private void initCheckWifi() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            if (!WifiConnected && MobileDataConnected) {
                Toast.makeText(Snacks2.this, "You are using mobile data connection", Toast.LENGTH_LONG).show();
            }
        } else {
            Toast.makeText(Snacks2.this, "NO CONNECTION!", Toast.LENGTH_SHORT).show();
            noConnectionDialog();
        }
    }
        ...
        call.enqueue(new Callback<snacksResult>() {
            ...
            public void onResponse(@NonNull Call<snacksResult> call, @NonNull Response<snacksResult> response) {
                if (response.code() == 200) {
                    ...
                    Toast.makeText(Snacks2.this, "server error", Toast.LENGTH_LONG).show();
                }
            ...
            public void onFailure(@NonNull Call<snacksResult> call, @NonNull Throwable t) {
                Toast.makeText(Snacks2.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
